...
async def start_meg(client, update):
    ...
    reply_markup =  InlineKeyboardMarkup( [[
        ...
        InlineKeyboardButton("🗣️Group", url="t.me/c_i_n_i_m_a_v_i_l_l_a"),
        InlineKeyboardButton("Channel📢", url="t.me/kurup_foryou")
        ]]
    )
...
async def callback_data(client, update: CallbackQuery):
    ...
    if query_data == "heroku":
        buttons = [[
            InlineKeyboardButton("Developer👩‍💻", url="https://t.me/c_i_n_i_m_a_v_i_l_l_a")
            ],[
        ...
        await update.message.edit_text(
            f"""<b>🔻AutoCaption Bot🔻\n\nTake a look at the end of the video\nIt has to say\n\n Developer👩‍💻\n\nHeroku 👉 https://t.me/c_i_n_i_m_a_v_i_l_l_a\n\n {MT}</b>""",
            reply_markup=reply_markup,
            parse_mode="html"
        )
    ...
    if query_data == "about":
        ...
        await update.message.edit_text(
            """<b>➪ Bot Name</b> AutoCaptionBot\n\n➪ <b>Framework : Pyrogram</b>\n\n➪<b> Language : Python</b>\n\n➪<b> Server : Heroku</b> \n\n<b>➪ Version : 2.0.1</b>\n\n<b>➪ Source Code  : <a href="https://t.me/c_i_n_i_m_a_v_i_l_l_a">Touch Me 🤗</a>\n\n➪ Developer :  ᗅℬℍⅈℐⅈᝨℍ\n\n➪ Credits : <a href="https://t.me/DREM_HAKER">Credits</a></b>""",
            reply_markup=reply_markup,
            parse_mode="html"
        )
